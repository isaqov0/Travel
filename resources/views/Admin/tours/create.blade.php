...
@section('content')
    ...
    <main id="main" class="main">
        <div class="card-body">
            ...
            <form action="{{route('admin.tours.store')}}" method="POST" enctype="multipart/form-data" class="row g-3" >
                @csrf
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <div class="form-floating">
                        <input name="departure_city" type="text" class="form-control" id="floatingName" >
                        <label for="floatingName">Departure City</label>
                    </div>
                @if($errors->has('departure_city'))
                    <span class="error" style="color: darkred">{{$errors->first('departure_city')}}</span>
                @endif
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-4">
                    <div class="form-floating">
                        <input name="price" type="number" class="form-control" id="floatingName">
                ...
                <div class="col-12">
                    <div class="form-floating">
                                    <textarea name="description"  class="form-control" placeholder="Address" id="floatingTextarea"
                ...
                <div class="col-md-6">
                    <div class="col-md-12">
                        <div class="form-floating">
                            <input name="duration" type="number" class="form-control" id="floatingCity">
                ...
                <div class="col-md-6">
                    <div class="col-md-12">
                        <div class="form-floating">
                            <input name="image" multiple type="file" class="form-control" id="floatingCity">
                ...
                <div class="col-md-6">
                    <div class="col-md-12">
                        <div class="form-floating">
                            <input name="date" class="form-control " type="date" id="fromDate">
