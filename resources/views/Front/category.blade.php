    ...
    <nav class="nav-breadcrumbs">
        <div class="container">
            <p id="breadcrumbs" class="breadcrumbs"><span><span><a href="https://kochevnik.kg/">Турагенство</a> | <span
                                class="breadcrumb_last" aria-current="page">Экскурсионный тур</span></span></span></p>
        </div>
    </nav>
    <main id="main" class="main" role="main">
        <div class="article__header page-tour__header">
            ...
            <div class="page-tour__header-cont">
                <div class="container">
                    <h1 class="article__head page-tour__head">Экскурсионный тур</h1>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="articles-wrap main-tours-wrap">
                ...
                <article class="tour-loop article-loop main-tour">
                    ...
                    <h3 class="tour-loop__title main-tour__title match-height">
                        <a href="tours/page/{{$tour->id}}" title="Наследие Турции">
                            {{$tour->name}} </a>
                    </h3>
            ...
            <div class="pagination">
                ...
                <a class='page-numbers' href='https://kochevnik.kg/rest_type/jekskursionnyj-tur/page/2/'>2</a>
                <a class='page-numbers' href='https://kochevnik.kg/rest_type/jekskursionnyj-tur/page/3/'>3</a>
                <span class="page-numbers dots">&hellip;</span>
                <a class='page-numbers' href='https://kochevnik.kg/rest_type/jekskursionnyj-tur/page/6/'>6</a>
                <a class="next page-numbers" href="https://kochevnik.kg/rest_type/jekskursionnyj-tur/page/2/">>></a>
            </div>
            ...
            <div class="cat-list-wrap">
                ...
                <ul class="cat-list cat-list--rest">
                    ...
                    <li class="cat-list__item">
                        <a href="{{$category->id}}" class="cat-list__link">
